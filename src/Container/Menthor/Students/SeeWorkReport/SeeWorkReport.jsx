...
import CategoriesFilter
    from "../../../../Componants/CategoriesFilter/CategoriesFilter.jsx";
...
const SeeWorkReport = ({showCategories, setShowCategories}) => {
    ...
    return (
        <div>
            ...
            <TableList head={mentorPageStudentsWorkReport.tableHead} body={mentorPageStudentsWorkReport.tableBody}/>
        </div>
    )
}
