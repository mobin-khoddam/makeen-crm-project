import { WorkCardStatusList } from "../../../../../../helper/ProjectData/Data.js";
...
const ShowStatusList = () => {
    return (
        <div className="grid grid-cols-11  max-[1380px]:grid-cols-6 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 w-full">
            {
                WorkCardStatusList.map((item, index) => (
                    <div className="text-sm odd:bg-white even:bg-gray-table w-full border-b">
