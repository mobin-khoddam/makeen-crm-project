...
function ImageUploader() {
    ...
    return (
        <div className='max-sm:w-full'>
            <div
                className="w-[333px] h-[333px] border-4 border-dashed relative flex justify-center items-center max-sm:w-full">
                <div>
                    <img className="w-[70px] h-[45px] mx-auto mb-5" src={imageIcon} alt=""/>
                    <div className="flex flex-col justify-center items-center">
                        <div>
                            <span className="text-[#1E3A8A] font-semibold">browse</span>{' '}
                            <label htmlFor="fileInputImageUploader">فایل خود را اینجا بیاندازید</label>
                        </div>
