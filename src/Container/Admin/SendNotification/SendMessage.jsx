    ...
    <>
      <div className="flex flex-col gap-5  lg:items-center lg:flex-row">
        ...
        <div className="w-full flex items-center gap-x-8  h-fit overflow-auto pb-2">
          ...
          <button className=" !min-w-[122px] h-[40px] text-[#4318FF] border-[1px] border-solid border-[#4318FF] font-semibold rounded-[10px] active:scale-95 transition-all duration-150 ease-linear">
            تایید
          </button>
        </div>
      </div>
      <div className="l w-full h-[43px] relative flex items-center mt-[31px] ">
        <svg
