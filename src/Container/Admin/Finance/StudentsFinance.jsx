...
import { adminFinanceStudents } from "../../../helper/ProjectData/Data";
import Pagination from "../../../Componants/Pagination/Pagination";

const StudentsFinance = () => {
  return (
    <div className="w-full">
      ...
      <AdminFinanceTable
        head={adminFinanceStudents.head}
        body={adminFinanceStudents.body}
      />
      <Pagination />
    </div>
  );
...
export default StudentsFinance;
