...
import { LatestTransActionFinanceData } from "../../../helper/ProjectData/Data";
import LatestTransActionFinanceTable from "./LatestTransActionFinanceTable";
...
const LatestTransactions = () => {
  return (
    <div className="w-full">
      ...
      <LatestTransActionFinanceTable
        body={LatestTransActionFinanceData.body}
        head={LatestTransActionFinanceData.head}
      />
      <Pagination />
    </div>
  );
