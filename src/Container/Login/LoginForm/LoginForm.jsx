      ...
      <form onSubmit={handleSubmit(onSubmit)} className="login-form-style">
        ...
        <div className="w-full relative mb-[51px]">
          <input
            ...
            className={`border w-full h-[56px] rounded-[10px] text-xs pr-8 outline-none ${
              userNameError ? "border-[#D30000]" : "border-primary-gray-100"
            }`}
            type="text"
          />
          <span
            className={`absolute right-5 -top-4 font-medium text-sm bg-white ${
              userNameError ? "text-[#D30000]" : "text-black"
            }`}
          >
            نام کاربری
          </span>
          ...
          <input
            ...
            placeholder={
              errors.password?.message
                ? "کلمه عبور خود مجدداً را وارد کنید "
                : "کلمه عبور خود را وارد کنید"
            }
            className={`border w-full h-[56px] rounded-[10px] text-xs pr-8 outline-none ${
              passwordError ? "border-[#D30000]" : "border-primary-gray-100"
            }`}
            type="text"
          />
          <span
            className={`absolute right-5 -top-4 font-medium text-sm bg-white ${
              passwordError ? "text-[#D30000]" : "text-black"
            }`}
          >
            کلمه عبور
          </span>
        ...
        <button
          type="submit"
          className="text-white bg-[#0593CE] w-full h-12 font-semibold text-xl rounded-[10px]"
        >
          ورود
        </button>
      </form>
