...
const DepositsTotal = () => {
  ...
  return (
    <>
      <div className="w-full lg:w-[665px] h-fit lg:h-[142px] rounded-[10px] border-[#261978] border-l-2 border-b-2 border-solid border-[1px] mb-[43px] mx-auto">
        <div className="w-[99%] lg:w-[659px] h-fit  lg:h-[137px] rounded-[10px] border-[#261978] border-solid border-[1px] border-b-2 border-t-0 border-r-0 pt-[17px] px-8 border-l-2 bg-white ">
          <div className="w-full h-fit md:h-fit  lg:h-[103px] flex flex-col justify-between ">
              ...
              <div className="flex items-center justify-between text-[#6D6D6D] text-[14px] max-lg:w-full">
                <button
                  ...
                  className={`w-[70px] h-8 ml-4  ${
                    state.first && "bg-[#261978] text-white"
                ...
                <button
                  ...
                  className={`w-[70px] h-8 mx-4 ${
                    state.second && "bg-[#261978] text-white"
                  } transition-all ease-linear duration-150 rounded-full`}
                >
                  ماهانه
                </button>
                ...
                <button
                  ...
                  className={`w-[70px] h-8 mr-4 rounded-full ${
                    state.third && "bg-[#261978] text-white"
            ...
            <div className="  flex items-center text-[#261978] justify-between  max-sm:flex-col gap-y-2">
              <span className="sm:text-[20px] text-[14px]">
                مجموع واریزی ها{" "}
              </span>
              <div className="flex items-center gap-x-2">
                <span className="sm:text-[12px] text-[10px]">تومان</span>
                <span className="text-[#261978] sm:text-[24px] text-[18px] ">
                  223.785.300
                </span>
              </div>
            </div>
